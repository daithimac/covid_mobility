...
# Dividing these by 100 so they are stored in their base form as decimals, rather than percentages
  ...
  measure: dynamic_metric {
    ...
    type: number
    sql:
    {% if metric._parameter_value == 'rnr' and daily_or_avg._parameter_value == 'daily'  %}
    ${avg_retail_and_recreation_percent_change_from_baseline}
    {% elsif  metric._parameter_value == 'rnr' and daily_or_avg._parameter_value == 'mov_avg'  %}
    ${retail_and_recreation_7_day_moving_avg}
    {% elsif  metric._parameter_value == 'residential' and daily_or_avg._parameter_value == 'daily'  %}
    ${avg_residential_percent_change_from_baseline}
    {% elsif  metric._parameter_value == 'parks' and daily_or_avg._parameter_value == 'daily'  %}
    ${avg_parks_percent_change_from_baseline}
    {% elsif  metric._parameter_value == 'grocery' and daily_or_avg._parameter_value == 'daily'  %}
    ${avg_grocery_and_pharmacy_percent_change_from_baseline}
    {% elsif  metric._parameter_value == 'transit' and daily_or_avg._parameter_value == 'daily'  %}
    ${avg_transit_stations_percent_change_from_baseline}
    {% elsif  metric._parameter_value == 'workplaces' and daily_or_avg._parameter_value == 'daily'  %}
    ${avg_workplaces_percent_change_from_baseline}
    {% elsif  metric._parameter_value == 'residential' and daily_or_avg._parameter_value == 'mov_avg'  %}
    ...
    {% elsif  metric._parameter_value == 'workplaces' and daily_or_avg._parameter_value == 'mov_avg'  %}
    ${workplaces_7_day_moving_avg}
    {% else %}
    ${avg_grocery_and_pharmacy_percent_change_from_baseline}
    {% endif %}
    ;;
